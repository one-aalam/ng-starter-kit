        ...
        <fieldset>
            ...
            <div className="modal-content form-controls">
                <div class="form-control">
                    ...
                    <input type="text" name="username" class="input input-bordered" required placeholder="Your username" formControlName="username" />
                </div>
                <div class="form-control">
                    <label class="label">
                        <span class="label-text">Website</span>
                    </label>
                    <input type="text" name="website" class="input input-bordered" placeholder="Your website" formControlName="website" />
                </div>
            </div>
            <div class="modal-action">
                <lib-button type="submit" variant="primary" [disabled]="profileForm.invalid || loading" [loading]="loading">Update Profile</lib-button>
